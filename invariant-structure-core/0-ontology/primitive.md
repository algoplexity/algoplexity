# 📜 INVARIANT STRUCTURE CORE — ONTOLOGY PRIMITIVES (v1.1)

## Layer: Ontology (Existence Only)

This document defines the **minimal set of objects and relations that exist** in the Invariant-Structure framework.
...
This document defines the **immutable ontological layer** of Invariant-Structure.
